        ...
        return (
            <ThemeProvider theme={theme}>
                <Autocomplete
                    ...
                    onChange={(event, value) => setSupplierName(value ? value.label : categories[0].label)}
                />
            </ThemeProvider>
        );
    };
            ...
            case ROLE.supplier:
                return (
                    <form onSubmit={registerHandler} className="col-right">
                        ...
                        <div className="item">
                            <input className='input' placeholder="Email liên lạc" onChange={(e) => { setContactEmail(e.target.value) }} />
                            <input className='input' placeholder="Tên người phụ trách" onChange={(e) => { setContactPersonName(e.target.value) }} />
                            <input className='input' placeholder="Địa chỉ người phụ trách" onChange={(e) => { setAddress(e.target.value) }} />
                            <input className='input' placeholder="Số điện thoại" onChange={(e) => { setContactPhone(e.target.value) }} />
                            <input className='input' placeholder="Tên công ty" onChange={(e) => { setName(e.target.value) }} />
                            <input className='input' placeholder="Số điện thoại công ty" onChange={(e) => { setPhoneNumber(e.target.value) }} />
                            <input className='input' placeholder="Địa chỉ công ty" onChange={(e) => { setSupplierAddress(e.target.value) }} />
                            <input className='input' placeholder="Tên công ty" onChange={(e) => { setSupplierName(e.target.value) }} />

                            {/* {CustomDropdown()} */}
                        </div>
                        <div className="item">
                            <Button type='submit' className="btn-login" variant="contained">Đăng ký</Button>
                        </div>
                    </form>
                )
            ...
            default:
                return (
                    <form onSubmit={registerHandler} className="col-right">
                        ...
                        <div className="item">
                            <input className='input' placeholder="Tên của bạn" onChange={(e) => { setPartnerName1(e.target.value) }} />
                            <input className='input' placeholder="Tên bạn đời" onChange={(e) => { setPartnerName2(e.target.value) }} />
                            <input className='input' placeholder="Số điện thoại" onChange={(e) => { setPhoneNumber(e.target.value) }} />
                            <input className='input' placeholder="Địa chỉ" onChange={(e) => { setAddress(e.target.value) }} />
                            <input className='input' type="text" name="date" pattern="\d{4}-\d{2}-\d{2}" placeholder="Ngày cưới (YYYY-MM-DD)" onChange={(e) => { setWeddingDate(e.target.value) }} />
                        </div>
                        <div className="item">
                            <Button type='submit' className="btn-login" variant="contained">Đăng ký</Button>
                        </div>
                    ...
                    (!isInput) ?
                        (
                            <div className="col-right">
                                ...
                                <div className="item">
                                    <div className='already-register'>Đã có tài khoản? <strong className="register hover-primary" onClick={() => { navigate("/login") }}>Đăng nhập ngay</strong></div>
                                </div>
                                <div className="item">
                                    ...
                                    <input className='input' placeholder="Nhập lại mật khẩu" type="password" onChange={(e) => { setConfirmPassword(e.target.value) }} />
                                </div>
                                <div className="item">
                                    <Button type='submit' className="btn-login" variant="contained" onClick={() => { handlePasswordConfirmation() }}>Tiếp tục</Button>
                                </div>
